...
set DOWNLOAD=0
powershell -Command "$request=${env:GITURL}; Write-Output (Invoke-WebRequest -UseBasicParsing $request |ConvertFrom-Json |Select tag_name -ExpandProperty tag_name)">latest_release
